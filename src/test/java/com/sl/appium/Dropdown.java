...
public class Dropdown {
	...
	public void sampleTest() 
	{
		...
		.release()
		.perform();
		MobileElement el3 = (MobileElement) driver.findElementByXPath("//android.widget.TextView[@content-desc=\"Spinner\"]");
		el3.click();

		MobileElement dropdowncolor=(MobileElement) driver.findElementById("android:id/text1");

		dropdowncolor.click();

		MobileElement selectcolor=(MobileElement) driver.findElementsByXPath("//android.widget.CheckedTextView[@text='orange']");
